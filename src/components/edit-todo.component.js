			...
			<div>
			  ...
			  <form onSubmit={this.onSubmit}>
			    ...
			    <div className="form-check">
			      <input className="form-check-input" id="completedCheckbox" type="checkbox" name="completedCheckbox" checked={this.state.todo_completed} onChange={this.onChangeTodoCompleted}  value={this.state.todo_completed} />
